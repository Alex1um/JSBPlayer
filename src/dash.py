...
def check_if_point_safe(frame_size, point, dangerous_countours, objects, radiuses):
...
def get_dash_coords(frame_size, player_pos, dangerous_countours, objects, radiuses):
